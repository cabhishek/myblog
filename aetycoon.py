...
class _TransformProperty(db.Property):
    ...
    def __get__(self, model_instance, model_class):
        ...
        setattr(
            model_instance, self.__transformed_attr_name(), transformed_val)
...
class ChoiceProperty(db.IntegerProperty):
    ...
    def __get__(self, model_instance, model_class):
        if model_instance is None:
            return self
        index = super(ChoiceProperty, self).__get__(
...
class CompressedProperty(db.UnindexedProperty):
    ...
    # override value_to_str and str_to_value to implement a new
    # CompressedProperty
...
class ArrayProperty(db.UnindexedProperty):
    ...
    def get_value_for_datastore(self, model_instance):
        value = super(ArrayProperty, self).get_value_for_datastore(
            model_instance)
